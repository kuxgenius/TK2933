...
public class SexualPlant extends Plant{
	...
	public void countIndoorPlant(ArrayList<Plant> plantList) {
		for(Plant p: plantList) {
			if (p instanceof SexualPlant && p.getType().equals("Indoor"))
				indoor++;
		}
		System.out.println("Number of indoor SexualPlant: "+indoor);
	}
	
	public void countOutdoorPlant(ArrayList<Plant> plantList) {
		for(Plant p: plantList) {
			if (p instanceof SexualPlant && p.getType().equals("Outdoor"))
				outdoor++;
		}
		System.out.println("Number of outdoor SexualPlant: "+outdoor);
	}
